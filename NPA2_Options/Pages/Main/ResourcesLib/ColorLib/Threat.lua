-- Author      : Nogarder
-- Create Date : 2012/7/27 17:12:42
NPA_Options.RegisterPageFunc("ColorLibThreat",function()

	local CopyTable=CopyTable
	--localization
	local Localization=NPA_Options.Localization.PagesColorLibThreat
	---
	local parent=NPA_Options.MainFrame
	local entry=NPA_Setting.Color["Threat"]
	--
	local main=NPA_Options.Template.CreateFrameWithBar(parent,Localization["Threat"],210,260,nil,nil)
	main:Hide()
	...
	local Reset=function()
		local defaultcolor=NPA.SettingManager.GetDefault("Color")["Threat"]
		for index,button in pairs(buttons)do
	...
	----
	NPA_Options.RegisterPage("ColorLibThreat",main)
