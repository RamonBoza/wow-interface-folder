...
function arrowframeproto:OnLoad()
	...
	local fade1 = ZGV.ChainCall(arrow.warning:CreateAnimation("Alpha")) :SetDuration(0.5) :SetChange(1)  :SetOrder(1) .__END
	local fade2 = ZGV.ChainCall(arrow.warning:CreateAnimation("Alpha")) :SetDuration(0.5) :SetChange(-1) :SetOrder(2) .__END
