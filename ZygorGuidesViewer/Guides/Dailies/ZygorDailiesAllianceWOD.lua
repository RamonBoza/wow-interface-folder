...
Nightmare Bell |q Go Fetch##37146/1 |goto Auchindoun/1 64.1,56.4
step
Complete the dungeon
kill Teron'gor##77734 |q Go Fetch##37146/2
step
#include "A_Garrison_MediumBuilding"
talk Johnny Awesome##88022
turnin Go Fetch##37146 |tip Turn in NPCs can sometimes be found behind the tavern or downstairs.
step
label "everbloom"
Fight through the dungeon
...
Very Shiny Thing |q Budd's Gambit##37145/1 |goto Iron Docks/1 85.0,48.0
step
Complete the dungeon
kill Skulloc##83612 |q Budd's Gambit##37145/2
step
#include "A_Garrison_MediumBuilding"
talk Budd##88017
turnin Budd's Gambit##37145 |tip Turn in NPCs can sometimes be found behind the tavern or downstairs.
|next "queuemenu"
step
label "shadowmoon"
Fight through the dungeon
...
step
Complete the dungeon
kill 1 Skylord Tovra##80005 |q Learning Is Painful##37242/2 |goto Grimrail Depot/4 15.3,51.7
step
Complete the dungeon
kill 1 Skylord Tovra##80005 |q An Axe to Grind##37243/2 |goto Grimrail Depot/4 15.3,51.7
step
#include "A_Garrison_MediumBuilding"
...
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Dailies Guides\\Warlords of Draenor\\Garrison Dailies",[[
...
accept Assault on Darktide Roost##36679 |or |next "darktideroost"
accept Assault on Socrethar's Rise##36680 |or |next "socretharsrise"
accept Assault on the Iron Siegeworks##36696 |or |next "ironsiegeworks"
accept Assault on Lost Veil Anzu##36681 |or |next "lostveil"
accept Assault on Pillars of Fate##36682 |or |next "pillarsoffate"
accept Assault on Shattrath Harbor##36649 |or |next "shattharbor"
accept Assault on Skettis##36683 |or |next "skettis"
accept Assault on Stonefury Cliffs##36648 |or |next "stonefurycliffs"
accept Assault on Magnarok##36675 |or |next "magnarok"
accept Assault on the Broken Precipice##36677 |or |next "brokenprecipice"
accept Assault on the Everbloom Wilds##36676 |or |next "everbloomwilds"
accept Assault on Mok'gol Watchpost##36678 |or |next "mokgolwatchpost"
|confirm
step
label "darktideroost"
...
click Rylak Eggs##234587
Assault Darktide Roost |q Assault on Darktide Roost##36679/1 |goto Shadowmoon Valley D 59.1,86.0 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on Darktide Roost##36679
|next "end"
step
...
Assault Socrethar's Rise |q Assault on Socrethar's Rise##36680/1 |goto Shadowmoon Valley D/0 46.9,75.1 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on Socrethar's Rise##36680
|next "end"
step
...
Assault Lost Veil Anzu |q Assault on Lost Veil Anzu##36681/1 |goto Spires of Arak 73.3,45.4 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on Lost Veil Anzu##36681
|next "end"
step
label "pillarsoffate"
...
Assault the Pillars of Fate |q Assault on Pillars of Fate##36682/1 |goto Spires of Arak/0 72.5,29.5 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on Pillars of Fate##36682
|next "end"
step
label "shattharbor"
...
Assault the Shattrath Harbor |q Assault on Shattrath Harbor##36649/1 |goto Talador 45.0,27.0 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on Shattrath Harbor##36649
|next "end"
step
label "skettis"
Fly to _Akeeta's Hovel_ |goto Spires of Arak/0 65.7,17.5 < 10
...
Assault Skettis |q Assault on Skettis##36683/1 |goto Spires of Arak/0 58.9,11.3 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on Skettis##36683
|next "end"
step
...
Assault Stonefury Cliffs |q Assault on Stonefury Cliffs##36648/1 |goto Frostfire Ridge 44.8,20.5 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on Stonefury Cliffs##36648
|next "end"
step
label "magnarok"
...
Assault Magnarok |q Assault on Magnarok##36675/1 |goto Frostfire Ridge/0 70.0,30.3 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on Magnarok##36675
|next "end"
step
...
Exploit the conflict at the Broken Precipice |q Assault on the Broken Precipice##36677/1 |goto Nagrand D/0 37.4,23.3 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on the Broken Precipice##36677
|next "end"
step
...
Assault the Botani forces in the Everbloom Wilds |q Assault on the Everbloom Wilds##36676/1 |goto Gorgrond 61.8,37.7 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on the Everbloom Wilds##36676
|next "end"
step
...
Assault the Warsong force |q Assault on Mok'gol Watchpost##36678/1 |goto Nagrand D/0 43,37 |tip You can see the progress bar in your quest tracker.
step
#include "A_Garrison_ScoutValdez"
turnin Assault on Mok'gol Watchpost##36678
|next "end"
step
label "end"
...
Fat Sleeper Egg |q Fat Sleeper##36513/1
|only if havequest(36513)
step
talk Ron Ashton##77733
turnin Fat Sleeper##36513 |goto Lunarfall/0 54.0,14.8
|next "end"
|only if havequest(36513)
step
Fish in the lava here |cast Fishing##131474 |goto Frostfire Ridge/0 50.7,60.4
...
Fire Ammonite Egg |q Fire Ammonite##36510/1
|only if havequest(36510)
step
talk Ron Ashton##77733
turnin Fire Ammonite##36510 |goto Lunarfall/0 54.0,14.8
|next "end"
|only if havequest(36510)
step
...
Blind Lake Sturgeon Egg |q Blind Lake Sturgeon##36514/1
|only if havequest(36514)
step
talk Ron Ashton##77733
turnin Blind Lake Sturgeon##36514 |goto Lunarfall/0 54.0,14.8
|next "end"
|only if havequest(36514)
step
...
Abyssal Gulper Eel Egg |q Abyssal Gulper Eel##36517/1
|only if havequest(36517)
step
talk Ron Ashton##77733
turnin Abyssal Gulper Eel##36517 |goto Lunarfall/0 54.0,14.8
|next "end"
|only if havequest(36517)
step
...
Blackwater Whiptail Egg |q Blackwater Whiptail##36515/1
|only if havequest(36515)
step
talk Ron Ashton##77733
turnin Blackwater Whiptail##36515 |goto Lunarfall/0 54.0,14.8
|next "end"
|only if havequest(36515)
step
...
Jawless Skulker Egg |q Jawless Skulker##36511/1
|only if havequest(36511)
step
talk Ron Ashton##77733
turnin Jawless Skulker##36511 |goto Lunarfall/0 54.0,14.8
|next "end"
|only if havequest(36511)
step
label "end"
...
accept Battle Pet Roundup##36483 |or |only if hasbuilding(42) |goto Lunarfall 29.2,40.4 |tip Defeat the challenger in pet combat!
accept Mastering the Menagerie##37644 |or |only if hasbuilding(168) |goto Lunarfall 29.2,40.4 |tip Defeat the challenger in pet combat!
step
talk Lio the Lioness##85418
turnin Battle Pet Roundup##36483 |only if havequest(36483) |goto Lunarfall 29.2,40.4
