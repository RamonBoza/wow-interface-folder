...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Felcloth",[[
	...
	step
		In order to complete the Blasted Lands questline for Loremaster of Eastern Kingdoms you will need to _speak with Zidormi_ to change the zone back to normal
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Netherweave Cloth",[[
	...
	step
		...
		|meta crap_items_follow=1
		goldcollect 392 Sunfury Signet##30810
		goldcollect 24 Arcane Tome##29739
		goldtracker
		_Click here_ to sell items |confirm
	step
		#include "auctioneer"
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Raw Elekk Meat",[[
	...
	step
		...
		from Pearltusk Calf##78371+, Pearltusk Bull##78387+, Pearltusk Grazer##78385+, Rockhide Calf##87699+, Rockhide Grazer##87700+, Rockhide Bull##87698+
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Raw Boar Meat, Rylak Egg",[[
	...
	step
		...
		from Coldsnout Boar##75416+, Coldsnout Sow##79756+, Pack Boar##80174+, Glacial Icemaw##78314+
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Raw Talbuk Meat",[[
	...
	step
		...
		from Thorncoat Talbuk##86727+, Breezestrider Talbuk##78278+, Breezestrider Stallion##78279+, Breezestrider Colt##78277+
		goldcollect 132 Raw Talbuk Meat##109132
		|meta crap_items_follow=1
		goldcollect 156 Sumptuous Fur##111557
		goldcollect 148 Hearty Soup Bone##113578
		goldcollect 340 Gorian Artifact Fragment##118099
		goldtracker
		_Click here_ to sell items |confirm
	step
		#include "auctioneer"
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Essence Of Undeath",[[
	...
	step
		...
		path	46.8,53.8
		from Anguished Highborne##7524+, Suffering Highborne##7523+, Wretched Spectre##48665+, Betrayed Ranger##48670+, Wretched Spirit##48664+ |tip Enter the buildings and kill the mobs inside as well
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Ichor Of Undeath",[[
	...
	step	
		from Risen Guard##58822+, Reanimated Corpse##59501+ |goto Scholomance/2 59.6,19.1
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Tigerseye, Malachite",[[
	...
	step
		Copper ore is _most abundant_ in Durotar and Darkshore. Please select where you would like to farm. |tip While they yield the same spawn locations for ore Darkshore seems to yield more based on a much smaller local player population.
	...
	step "durotar"
		...
		path	37.9,30.4	39.6,17.6	42.8,19.7
		path	44.6,24.6	48.0,36.6	49.6,32.1
		path	50.5,27.3	50.0,22.6	49.8,16.8
		_Mine Copper Veins_ along the path
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Shadowgem, Moss Agate, Lesser Moonstone, Jade",[[
	...
	step
		Tin ore is _most abundant_ in Ashenvale and Northern Stranglethorn. Please select where you would like to farm. |tip While they yield about the same spawn locations for ore Ashenvale's trees are not as dense so flying around searching for veins is much easier.
	...
	step "northern"
		...
		path	41.4,41.2
		_Mine Tin Veins_ along the path |tip Silver cannot be prospected but can generate additional income
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Citrine, Aquamarine",[[
	...
	step
		...
		_Mine_ Mithril Deposit along the path |tip Truesilver and Gold cannot be prospected but can generate additional income
	...
	step "badlands"
		...
		_Mine Mithril Deposits_ along the path |tip Truesilver and Gold cannot be prospected but can generate additional income
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Huge Emerald, Large Opal, Azerothian Diamond, Blue Sapphire, Star Ruby",[[
	...
	step
		...
		_Mine_ Thorium Veins along the path |tip Truesilver cannot be prospected but can generate additional income
	...
	step "winterspring"
		...
		_Mine Thorium Veins_ along the path |tip Truesilver cannot be prospected but can generate additional income
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Golden Draenite, Azure Moonstone, Blood Garnet, Deep Peridot, Flame Spessarite, Shadow Draenite",[[
	...
	step
		...
		_Mine_ Fel Iron and Adamantite Deposits along the path |tip Eternium cannot be prospected but can generate additional income
	...
	step "hellfire"
		...
		_Mine Fel Iron Deposits_ along the path |tip Eternium cannot be prospected but can generate additional income
		goldcollect 16 Eternium Ore##23427
...
ZygorGuidesViewer:RegisterGuide("GOLD\\Farming\\Adamantite Powder, Living Ruby, Talasite, Nightseye, Star Of Elune, Dawnstone, Noble Topaz",[[
	...
	step
		...
		_Mine Fel Iron_ and _Adamantite Deposits_ along the path |tip Eternium and Khorium cannot be prospected but can generate additional income
