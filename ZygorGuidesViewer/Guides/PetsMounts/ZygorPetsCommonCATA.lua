...
description This guide will walk you through obtaining
description the Beast pet:Alterac Brew-Pup
pet 1363
step
.' This pet can be purchased from the official Blizzard Store in the near future. No release date has been announced as of yet.
...
pet 52
step
goto Thousand Needles 85.6,91.6
.talk 41135
...
pet 649
step
goto Sholazar Basin 45.6,53.6
.' The _Biletoads_ in this area are around level 18. Challenge one to a pet battle and capture it.
...
description This guide will walk you through obtaining
description the Magic pet:Darkmoon Eye
pet 1063
step
goto Darkmoon Island 47.8,62.6
.talk 67370
..accept 32175
step
.' Tell him, 'Let's fight!'
.' Defeat Jeremy Feasel |q 32175/1 |tip His pets are all level 25 epic, so you will need to have level 25 pets in order to defeat him.
step
goto Darkmoon Island 47.8,62.6
.talk 67370
..turnin 32175
step
.' Open your Darkmoon Pet Supplies |use Darkmoon Pet Supplies##91086 |tip You may not get this right away. If you don't, you will have to come back the next day and re-do this daily.
...
description This guide will walk you through obtaining
description the Critter pet:Darkmoon Hatchling
pet 1061
step
goto Darkmoon Island,56.0,52.9 |n
.' Follow the Path to the Darkmoon Faire |goto Darkmoon Island,56.0,52.9,1 |noway |c
...
goto Darkmoon Island,48.2,69.6
.talk 14846
.buy 1 Darkmoon Hatchling##91003
|modeldisplay 46163
step
...
pet 232
step
goto Dustwallow Marsh 48.0,14.2
...
description This guide will walk you through obtaining
description the Humanoid pet:Murkalot
pet 1364
step
.' This pet is available only to people who purchase a ticket to the live stream of BlizzCon 2013.
.' If you desperately want this pet, but did not attend the event, you may be able to find a copy on Amazon or eBay. However, they are typically very expensive.
...
.' Note that if you clear the instance once, you will likely need to reset the instance.
.' Do this by going to your character portrait and right clicking.
.' The sixth option down should be _Reset all instances_.
|modeldisplay 29807
step
...
_Open_ the Oozing Bag |use Oozing Bag##20768
collect 1 Disgusting Oozeling##20769 |tip This has a very low drop rate, you may be farming here for a while
step
...
pet 514
step
goto Terokkar Forest 58.0,13.2
...
.' Please note that this requires the _Midsummer Fire Festival_ Holiday.
step
...
pet 49
step
goto Northern Stranglethorn 60.0,70.4
...
.talk 9499
.collect 10 Dark Iron Ale Mug##11325 |tip Buy all that he has to offer.
step
goto Darkmoon Island 55.8,70.6
...
pet 235
step
goto Northern Barrens 62.8,20.2
...
goto The Cape of Stranglethorn 43.0,72.0
.talk 648
..turnin 25476
..turnin 648
..turnin 836
...
pet 149
step
goto Terokkar Forest 53.7,72.3
.talk 22424
..accept 10898
...
description This guide will walk you through obtaining
description the Undead pet:Mr. Bigglesworth
pet 1145
step
...
description This guide will walk you through obtaining
description the Humanoid pet:Murki
pet 1168
step
'This pet was available to Korean players during one of their promotional events. This pet is no longer available to players.
...
pet 239
step
goto Northern Stranglethorn 28.0,23.1
...
.' The _Robo-Chicks_ in this area are level 17. Challenge one to a pet battle and capture it.
...
pet 291
step
goto Hillsbrad Foothills 33.6,49.2
.talk 49687
..accept 28733
step
...
.' The _Tiny Bog Beasts_ are around level 6. Challenge one to a pet battle and capture it.
...
description This guide will walk you through obtaining
description the Magic pet:Mini Mindslayer
pet 1156
step
goto Ahn'Qiraj/2 43.4,41.5
.from The Prophet Skeram##15263
.collect Jewel of Maddening Whispers##93041
.' Please note that this item has an _extremely low drop rate_ and will likely take a while to obtain.
step
...
description This guide will walk you through obtaining
description the Magic pet:Viscidus Globule
pet 1154
step
map Ahn'Qiraj/2
...
description This guide will walk you through obtaining
description the Humanoid pet:Anubisath Idol
pet 1155
step
map Ahn'Qiraj/2
path follow loose;loop off;ants straight
...
description This guide will walk you through obtaining
description the Dragonkin pet:Untamed Hatchling
pet 1151
step
...
description This guide will walk you through obtaining
description the Dragonkin pet:Death Talon Whelpguard
pet 1153
step
.' For this achievement, you will either need to be grouped with a player that can enter Blackwing Lair, or get attuned to enter yourself.
.' Click here if you want to go through the attunement process. |confirm
...
description This guide will walk you through obtaining
description the Dragonkin pet:Chrominius
pet 1152
step
.' For this achievement, you will either need to be grouped with a player that can enter Blackwing Lair, or get attuned to enter yourself.
.' Click here if you want to go through the attunement process. |confirm
...
description This guide will walk you through obtaining
description the Undead pet:Giant Bone Spider
pet 1143
step
...
description This guide will walk you through obtaining
description the Undead pet:Stitched Pup
pet 1146
step
...
description This guide will walk you through obtaining
description the Undead pet:Fungal Abomination
pet 1144
step
...
description This guide will walk you through obtaining
description the Humanoid pet:Harbinger of Flame
pet 1147
step
.' Follow the path into the Molten Core. |goto Molten Core/1 42.7,13.6 |c
step
goto Molten Core/1 34.7,48.3
.from Gehennas##12259
...
description This guide will walk you through obtaining
description the Humanoid pet:Corefire Imp
pet 1149
step
.' Follow the path into the Molten Core. |goto Molten Core/1 42.7,13.6 |c
step
...
description This guide will walk you through obtaining
description the Elemental pet:Ashstone Core
pet 1150
step
.' Follow the path into the Molten Core. |goto Molten Core/1 42.7,13.6 |c
step
...
description This guide will walk you through obtaining
description the Mechanical pet:Fluxfire Feline
pet 1162
step
...
description This guide will walk you through obtaining
description the Mechanical pet:Cogblade Raptor
pet 1164
step
goto Blade's Edge Mountains 59.6,64.6
.' The _Cogblade Raptors_ in the area are level 19.
.learnpet Cogblade Raptor##68841
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Pets & Mounts Guide\\Pets\\Anodized Robo Cub",[[
description This guide will walk you through obtaining
description the Mechanical pet:Anodized Robo Cub
pet 1163
step
goto Winterspring 61.07,50.12
.' You will need to camp most likely for this pet to appear.
.' Fight other battle pets in the area to try and force it's spawn.
.' The _Anodized Robo Cub_ is level 18.
.' [58.74,45.63]
.learnpet Anodized Robo Cub##68839
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Pets & Mounts Guide\\Pets\\Arcane Eye",[[
description This guide will walk you through obtaining
description the Magic pet:Arcane Eye
pet 1160
step
goto Deadwind Pass 46.0,78.0
.' The _Arcane Eyes_ in the area are around level 18.
.learnpet Arcane Eye##68819
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Pets & Mounts Guide\\Pets\\Lofty Libram",[[
description This guide will walk you through obtaining
description the Magic pet:Lofty Libram
pet 1159
step
...
description This guide will walk you through obtaining
description the Dragonkin pet:Emerald Proto-Whelp
pet 1167
step
goto Sholazar Basin 46.0,24.9
.' The _Emerald Proto-Whelps_ in the area are around level 22.
.learnpet Emerald Proto-Whelp##68850
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Pets & Mounts Guide\\Pets\\Nexus Whelpling",[[
description This guide will walk you through obtaining
description the Dragonkin pet:Nexus Whelpling
pet 1165
step
goto Borean Tundra 34.1,25.2
.' The _Nexus Whelplings_ around the area are level 21.
.learnpet Nexus Whelpling##68845
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Pets & Mounts Guide\\Pets\\Harpy Youngling",[[
description This guide will walk you through obtaining
description the Humanoid pet:Harpy Youngling
pet 1157
step
...
description This guide will walk you through obtaining
description the Dragonkin pet:Infinite Whelpling
pet 1161
step
goto Tanaris 62.5,50.0
.' The _Infinite Whelplings_ in the area are around level 14.
.learnpet Infinite Whelpling##68820
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Pets & Mounts Guide\\Pets\\Stunted Yeti",[[
description This guide will walk you through obtaining
description the Humanoid pet:Stunted Yeti
pet 1158
step
goto Feralas 53.3,56.0
.' The _Stunted Yetis_ in the area are around level 12.
.learnpet Stunted Yeti##68805
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Pets & Mounts Guide\\Pets\\Kun-Lai Runt",[[
description This guide will walk you through obtaining
description the Humanoid pet:Kun-Lai Runt
pet 1166
step
goto Kun-Lai Summit 50.7,53.4
.' The _Kun-Lai Runts_ in the area are around level 23.
.learnpet Kun-Lai Runt##68846
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Pets & Mounts Guide\\Pets\\Crow",[[
description This guide will walk you through obtaining
description the Flying pet:Crow
pet 1068
step
map Darkmoon Island
...
.' They share spawn points with the glowflies, so wait around after you kill a group.
.' The _Crows_ will be around level 10.
.learnpet Crow##67443
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Pets & Mounts Guide\\Pets\\Darkmoon Glowfly",[[
description This guide will walk you through obtaining
description the Flying pet:Darkmoon Glowfly
pet 1062
step
goto Darkmoon Island 58.6,63.4
.' The _Darkmoon Glowflies_ in the area are around level 10.
.learnpet Darkmoon Glowfly##67329
]])
ZygorGuidesViewer:RegisterGuide("Zygor's Alliance Pets & Mounts Guide\\Pets\\Blossoming Ancient",[[
description This guide will walk you through obtaining
description the Elemental pet:Blossoming Ancient
pet 1248
step
.' This pet can be purchased for $10.00 on the official Blizzard Store.
.' After purchasing, check your in-game mailbox
