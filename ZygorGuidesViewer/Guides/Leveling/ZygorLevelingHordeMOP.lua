...
..accept 31765
step
.' Follow the steps down. |goto 31.4,11.0 <5 |c
step
goto 31.5,11.0
.' Click Gunship Turret |invehicle |c
...
..accept 31771
step
.' Follow the stairs back down and exit the building |goto 34.5,10.6 <5 |c
step
goto 30.6,7.1
.talk 66660
..accept 31772
...
step
.' Follow the road southwest |goto 28.3,30.9 <5 |c
step
goto 26.2,32.4
...
step
.' Go to the road, and follow it east |goto 40.0,48.1 <5 |c
step
goto The Jade Forest 46.6,45.3
.talk 59178
..turnin 29866
...
.' Destroy 6 Vacant Destroyer |q 29748/1
step
.' Click the Complete Quest box that displays on the right side of the screen under your minimap
..turnin 29748
..turnin 29747
...
.' Kill Ancient Spirits until the "Empowering the Staff" bar fills.  |q 29749/2
...
.' Recover 10 Wayward Ancestors |q 29752/1 |n
...
.' Recover 10 Wayward Ancestors |q 29752/1
|modelnpc Wayward Ancestor##55290
step
...
step
goto The Jade Forest 43.8,12.5
.talk 59492
..turnin 29755
step
.' Follow the path up |goto 39.2,14.8 <5 |c
step
.' Follow the path here |goto 38.0,18.2 <5 |c
step
.' Follow the path here |goto 38.2,24.1 <5 |c
step
.' Follow this path into the Tian Monastery. |goto 41.5,25.0 <5 |c
step
goto 43.6,24.5
.talk 59736
...
..accept 29636
step
.' Follow the stairs up |goto 42.0,24.3 <5 |c
step
.' Follow the stairs up |goto 42.1,23.6 <5 |c
step
goto 41.6,23.7
.talk 54915
..turnin 29626
...
step
goto 41.1,28.0
.kill 2 Training Bag##55183+ |q 29624/1
...
..turnin 29624
step
.' Follow this path |goto 41.4,26.8 <5 |c
step
goto 39.0,24.0
.talk 54918
..turnin 29636
...
step "greentrick"
.' You cannot mount for the next few steps while pulling the Cauldron behind you
|confirm
step
...
step
.' Go up the small hill here |goto 39.3,23.8 <5 |c
step
.' Cross the bridge |goto 40.8,25.0 <5 |c
step
,' Go up the stairs |goto 41.1,24.2 <5 |c
step
goto 41.6,23.7
...
..turnin 29631
step
.' Follow the stairs up |goto 41.1,24.3 <5 |c
step
goto 41.6,23.7
.talk 54915
..turnin 29629
...
..accept 29646
step
.' Go up the stairs |goto 42.4,25.0 <5 |c
step
goto 42.7,23.2
.talk 54914
..turnin 29646
step
.' Enter the cave |goto 46.0,29.1 <5 |c
...
..accept 30011
step "launchers"
.' Follow the path back |goto 58.0,56.2 <5 |c
step
...
..accept 30499
step
goto The Jade Forest 54.6,61.7
.talk 59727
..fpath Jade Temple Grounds
.' Tell her You could use a kite to Grooken' Hill. |goto 28.0,47.0 <5 |c
step
goto The Jade Forest 28.0,47.2
.talk 57108
..turnin 30499
...
step
goto Valley of the Four Winds 85.5,33.3
...
step
.' Go to the road |goto 81.2,31.1 <5 |c
step
goto Valley of the Four Winds 78.1,32.9
.talk 56208
.|tip He is on the ground next to the stairs
...
step
.' Go up this path |goto 60.8,25.7 <5 |c
step
goto 65.3,25.82
.from Krosh##56833
...
..accept 30058
step
goto Valley of the Four Winds 64.4,58
...
..accept 30057
step
.' Exit the warren |goto 43.6,35.0 <5 |c
step
goto 43.4,39.1
...
.kill Eddy##58014 |q 30078/1 |tip When Eddy activates his Watery Shield run over bubbles on the ground until it is weakened, then click the bubble to pop it.
...
goto Valley of the Four Winds 18.3,31.2
.talk 56714
.' Tell him You have done all that he has asked of you and you are ready for the trial of stone |invehicle
step
.' Follow the instructions and use the abilities on your hotbar to pass the trial.
...
step
goto Krasarang Wilds 74.0,16.9
...
.from Krasari Mogu##58377, Krasari Runekeeper##65598+
...
dynamic on
step
goto Valley of the Four Winds 40.5,34.0
.talk 63778
..accept 31255
step
...
..accept 30513
step
.' Cross the bridge |goto 72.4,91.5 <5 |c
step
goto 75.0,88.9
.talk 59263
..accept 30469
...
step
goto 65.7,81.0
.clicknpc Wild Plains Yak##59610 |tip Get 3 of these before going back to town. You can do this while mounted.
.from Highlands Mushan##59670+, Highlands Calf##59671+, Summit Bonestripper##59672+
.get 160 Kun Lai-Meaty Bits##80245 |q 31251/1
step
.' Make sure you have rounded up 3 yaks. You'll have a Captured Yak buff and it should have 3 stacks.
...
step
.' Follow the path north |goto 49.7,78.1 <5 |c
step
goto 48.4,76.7
...
.' There is a pool of water at [Kun-Lai Summit,66.3,48.5] that you can jump down safely to
step
goto 63.3,40.2
.talk 61380
