...
collect 38 Minor Healing Potion##118
step
#include "auctioneer"
...
path	31.8,62.6	33.9,54.0	38.3,53.5
path	41.1,51.6	46.2,49.4	52.9,48.7
path	56.4,51.3	60.1,51.3	63.1,49.9
path	65.7,46.0	69.5,44.7	69.7,49.5
path	69.7,54.1	70.3,57.9	68.6,61.4
path	66.3,63.6	62.9,63.8	60.4,62.5
path	58.2,65.7	56.2,68.5	54.8,72.1
path	52.4,70.3	50.1,68.4
#include "follow_path_herbs"
...
step
talk Haalrun##18005
buy 1 Recipe: Super Mana Potion##22907 |goto Zangarmarsh 67.8,48.0 |tip This recipe is a limited quality item. If the vendor is not carrying it, you may need to get it from the Auction House.
step
...
step
You will use the _Frost Lotus_ that you gathered from the Grand Master Alchemy section in the Illustrious Grand Master portion of the guide.
...
path	34.9,46.2	46.4,54.3	45.9,50.2
path	51.1,48.3	59.5,51.6	59.0,55.6
path	57.2,55.9	45.1,59.4	52.5,60.5
path	48.7,62.7	56.9,67.1	46.8,71.6
path	52.8,71.5	53.4,76.5	60.0,76.8
path	62.6,80.5	64.8,67.6	67.9,59.7
path	65.8,72.5	67.1,74.9	69.5,74.5
...
path 	71.1,70.6	66.0,68.5	29.7,43.5
...
step
If you plan on farming your own materials, you will need to keep any _Copper Bars_ and _Coarse Grinding Stones_ you have left over from the previous section.
...
buy 1 Plans: Lesser Ward of Shielding##23638 |goto Shadowmoon Valley,36.8,55.0 |tip Save this recipe, you will learn it later, when your Blacksmithing skill is higher.  This recipe is a limited supply item, so if it's not available for purchase, keep checking again every few minutes until you can buy it.
step
...
#include "shatt_anvil"
create Adamantite Bar##29358,Mining,100 total
...
learn Adamantite Cleaver##29568 |goto Shattrath City,64.1,71.9
step
#include "shatt_anvil"
...
#include "follow_path_mine"
collect 606 Saronite Ore##36912
#include "max_skill_warning",skill="Mining",goto="bla_350-425_farm"
step
label "exit"
#include "trainer_Mining"
...
step
#include "maincity_anvil"
create Saronite Bar##49258,Mining,303 total
collect 303 Saronite Bar##36913
step
...
step
#include "maincity_anvil"
create Obsidium Bar##84038,Mining,38 total
...
step
#include "maincity_anvil"
create Obsidium Skeleton Key##76438,Blacksmithing,480,10 total
step
#include "trainer_Blacksmithing"
learn Stormforged Legguards##76287
step
#include "maincity_anvil"
create Stormforged Legguards##76287,Blacksmithing,490,4 total
step
#include "trainer_Blacksmithing"
learn Stormforged Helm##76288
step
#include "maincity_anvil"
create Stormforged Helm##76288,Blacksmithing,500,3 total
step
label "route2"
...
learn Vicious Pyrium Gauntlets##76457 |goto Twilight Highlands 77.3,53.1
step
#include "twil_anvil"
...
learn Vicious Pyrium Belt##76458 |goto 77.3,53.1
step
#include "twil_anvil"
...
learn Vicious Ornate Pyrium Shoulders##76469 |goto 77.3,53.1
step
#include "twil_anvil"
...
home Old Town |goto Stormwind City 75.6,54.1
step
talk Drac Roughcut##1465
buy 1 Recipe: Smoked Bear Meat##6892 |goto Loch Modan,35.6,49.2
step
...
collect 60 Bear Meat##3173 |goto Elwynn Forest,80.8,59.2
...
buy 1 Recipe: Blood Sausage##3679 |goto 76.6,53.6
step
talk Elly Langston##1328
buy 30 Ice Cold Milk##1179 |goto 76.6,53.6
step
talk Kriggon Talsone##4305
buy 1 Recipe: Clam Chowder##5528 |goto Westfall,36.2,90.0
step
#include "auctioneer"
...
label "farming"
from Young Forest Bear##822+
collect 25 Bear Meat##3173 |goto Elwynn Forest,80.8,59.2
You can find more at [85.0,62.1]
You can find more at [88.5,77.9]
You can find more at [83.2,84.9]
You can find more at [48.5,76.5]
...
collect 30 Clam Meat##5503 |goto Ashenvale,10.7,14.5
step
...
step
talk Kendor Kabonka##340
buy 1 Recipe: Curiously Tasty Omelet##3682 |goto 76.6,52.9
step
...
buy 1 Recipe: Roast Raptor##12228 |goto Arathi Highlands,40.4,48.8
step
#include "auctioneer"
...
collect 48 Raptor Egg##3685 |goto Wetlands,33.7,22.6
step
label "farm2"
Skipping 2nd part of farming |next "+exit" |only if step:Find("+farming"):IsComplete()
Proceeding to farm |next |only if default
...
collect 56 Raptor Flesh##12184 |goto Un'Goro Crater 66.9,60.1
step
...
step
talk Malygen##2803
buy 1 Recipe: Monster Omelet##16110 |goto Felwood,61.2,26.5
step
#include "auctioneer"
...
buy 1 Recipe: Ravager Dog##27688 |goto Hellfire Peninsula,54.2,63.6
step
Use the Recipe: Ravager Dog in your bags |use Recipe: Ravager Dog##27688
learn Ravager Dog##33284
step
talk Uriku##20096
buy 1 Recipe: Talbuk Steak##27693 |goto Nagrand,56.2,73.3
step
...
accept Northern Cooking##13088 |goto Borean Tundra 57.9,71.5 |tip This quest is only available to you if you have 350+ Cooking skill.
step
...
get 7 Venture Co. Spare Parts |q 12523/1 |goto 32.7,46.9
step
kill 15 Venture Company member |q 12524/1 |goto 37.4,46.1
step
talk Weslex Quickwrench##28033
turnin Have a Part, Give a Part##12523 |goto 25.4,58.4
step
talk Debaar##28032
...
step
talk Debaar##28032
turnin Wipe That Grin Off His Face##12525 |goto 27.2,59.8
step
...
step
kill 15 Dreadsaber |q 12549/1 |goto 28,56
kill 15 Shardhorn Rhino |q 12520/1 |goto 28,56
...
accept Fletcher's Lost and Found##13571 |instant |goto Dalaran/2 43.2,24.4
step
talk Applebough##29547
buy 50 Savory Snowplum##35948 |goto Dalaran,43.1,57.0
buy 100 Tundra Berries##35949 |goto Dalaran,43.1,57.0
step
#include "auctioneer"
...
buy 1 Recipe: Blackened Worg Steak##43032 |goto Dalaran,40.7,66.0
step
...
buy 25 Worg Haunch##43011 |goto Dalaran,38.8,25.2
...
buy 1 Recipe: Whitecrest Gumbo##65406 |goto Stormwind City,50.4,71.9
step
...
step
talk Bario Matalli##49701
buy 1 Recipe: Hearty Seafood Soup##65418 |goto Stormwind City,50.4,71.9
step
...
label "cook_500_525"
talk Bario Matalli##49701
buy 1 Recipe: Grilled Dragon##65428 |goto Stormwind City,50.4,71.9
step
...
get 1 Jug of Wine |q 13101/2 |goto 55.0,30.8
step
...
step
collect 4 Infused Mushroom##43100 |q 13100 |goto Dalaran/2 59.5,43.6 |tip They spawn randomly along the sewer lines.
step
from Rabid Grizzly##26643+, Blighted Elk##26616+
...
create 1 Runed Copper Rod##7421,Enchanting,1 total |tip Save the Runed Copper Rod in your bags, you will need it to enchant items.
step
...
step
talk Dalria##3954
buy 1 Formula: Enchant Bracer - Lesser Strength##11101 |goto Ashenvale 35.1,52.1
buy 1 Formula: Enchant Cloak - Minor Agility##11039 |goto Ashenvale 35.1,52.1
step
...
collect 58 Soul Dust##11083 |goto Razorfen Kraul 69.89,82.97
collect 20 Lesser Mystic Essence##11134 |n |goto Razorfen Kraul 69.89,82.97
collect 40 Vision Dust##11137 |n |goto Razorfen Kraul 69.89,82.97
step
label "farm2"
...
buy 20 Crystal Vial##3371 |goto Stormwind City,62.8,75.1
step
#include "auctioneer"
...
collect 210 Dream Dust##11176 |goto Razorfen Downs 23.79,18.80 |tip You can also find Dream Dust by disenchating items in the Zul'Farrak dungeon.
collect 117 Vision Dust##11137 |goto Razorfen Downs 23.79,18.80
...
learn Enchant Shield - Greater Stamina##20017 |goto Darnassus,58.1,34.2
step
...
buy 1 Formula: Superior Wizard Oil##22563 |goto Shattrath City,63.6,70.0 |tip Save this in your bags, you will use it to learn the recipe later.
step
...
_1_  Cast the enchantments on Enchanting Vellum. This will allow you to sell the enchantments on the Auction House to recoup some of your costs.  You can buy the Vellums from Jessara Cordell at [Stormwind City,52.8,74.2]
__
_2_  You could advertise to enchant items for free, using the following enchantments, as long as the player provides their own materials needed for the enchantment.  This may take longer, but would allow you to level your Enchanting skill for free.
|confirm
step
...
step
label "farm2"
Skipping 2nd part of farming |next "ench_351-426_skill" |only if step:Find("+farming"):IsComplete()
Proceeding to farm |next |only if default
step
label "farming"
...
step
create 5 Enchant Bracer - Assault##60616,Enchanting,380 |tip You can keep enchanting the same item repeatedly.
step
#include "trainer_Enchanting"
...
step
create 4 Enchant Gloves - Haste##44484,Enchanting,417 |tip You can keep enchanting the same item repeatedly.
step
#include "trainer_Enchanting"
...
collect 5 Lesser Celestial Essence##52718 |n |goto The Vortex Pinnacle 54.12,16.81
collect 41 Greater Celestial Essence##52719 |n |goto The Vortex Pinnacle 54.12,16.81
step
...
Run through the Vortex Pinnacle dungeon, killing all mobs along the way
Disenchant any uncommon quality (green) armor and weapons with an item level of 272-305 and 305-333.|cast Disenchant##13262
collect 227 Hypnotic Dust##52555 |goto The Vortex Pinnacle 54.12,16.81
collect 107 Greater Celestial Essence##52719 |n |goto The Vortex Pinnacle 54.12,16.81
step
Run through the Stonecore dungeon, killing all mobs along the way
Disenchant any uncommon quality (green) armor and weapons with an item level of 272-305 and 305-333.|cast Disenchant##13262
collect 107 Greater Celestial Essence##52719 |goto The Stonecore 54.27,93.90
step
...
step
#include "maincity_anvil"
create Copper Bar##2657,Mining,60 total |tip Keep any extra Copper Bars you have for making items later.
step
label  "eng_1-75_skill"
create 50 Rough Blasting Powder##3918,Engineering,30
step
#include "trainer_Engineering"
...
step
Keep any _Copper Bars_ and _Tigerseye_ leftover from this section
Also keep an _Arclight Spanner_. You'll need it for crafting in the next section
Feel free to sell off anything else you might have created and any other leftover materials
|confirm
step
#include "auctioneer"
buy 24 Coarse Stone##2836
buy 5 Linen Cloth##2589
buy 95 Bronze Bar##2841
buy 6 Tigerseye##818
...
step
label "farm"
Skipping 1st part of farming |next "+farm2" |only if step:Find("+farming"):IsComplete() or skill("Engineering")>=130
Proceeding to farm |next |only if default
step
label "farming"
map Elwynn Forest
...
path	37.2,51.9
#include "follow_path_mine"
collect 48 Copper Ore##2770
collect 6 Tigerseye##818
step
label "farm2"
Skipping 2nd part of farming |next "+farm3" |only if step:Find("+farming"):IsComplete() or skill("Engineering")>=130
Proceeding to farm |next |only if default
step
label "farming"
...
step
label "farm3"
Skipping 3rd part of farming |next "+exit" |only if step:Find("+farming"):IsComplete() or skill("Engineering")>=130
Proceeding to farm |next |only if default
step
label "farming"
map Northern Stranglethorn
path follow loose;dist 25
...
path	57.2,28.2	60.8,34.6	62.9,47.1
path	56.2,50.4	48.0,55.2	44.3,55.5
path	48.7,47.2	47.7,39.2	50.2,28.6
path	44.6,28.2	42.9,34.7	41.4,41.2
#include "follow_path_mine"
collect 24 Coarse Stone##2836
collect 48 Tin Ore##2771
#include "max_skill_warning",skill="Mining",goto="eng_75-130_farm"
step
label "exit"
#include "maincity_anvil"
create Tin Bar##3304,Mining,48 total
create Copper Bar##2657,Mining,48 total
step
create Bronze Bar##2659,Mining,96 total
step
...
You will also need to keep the Bronze Bars you have left over
...
buy 50 Iron Bar##3575
buy 25 Wool Cloth##2592
buy 132 Solid Stone##7912
buy 198 Mithril Bar##3860
buy 35 Mageweave Cloth##4338
buy 4 Steel Bar##3859
buy 10 Gold Bar##3577
#include go_farm,skill="Mining",req="150",goto="eng_130-210_farm"
next "eng_130-210_skill"
step
label "eng_130-210_farm"
Skipping 1st part of farming |next "+farm2" |only if step:Find("+farming"):IsComplete() or skill("Blacksmithing")>=210
Proceeding to farm |next |only if default
step
label "farming"
from Anquished Spirit##45614+, Forlorn Spirit##43923+
collect 25 Wool Cloth##2592 |goto Duskwood,22.6,68.6
step
label "farm2"
Skipping 2nd part of farming |next "+farm3" |only if step:Find("+farming"):IsComplete() or skill("Blacksmithing")>=210
Proceeding to farm |next |only if default
step
label "farming"
map Western Plaguelands
...
collect 10 Gold Ore##2776
skill Mining,200
#include "max_skill_warning",skill="Mining",goto="eng_130-210_farm"
step
label "exit"
from Irontree Chopper##48453+
collect 35 Mageweave Cloth##4338 |goto Felwood,63.4,20.7
step
#include "trainer_Mining"
skillmax Mining,300
learn Smelt Mithril##10097
...
step
#include "maincity_anvil"
create Iron Bar##3307,Mining,46 total
step
create Steel Bar##3569,Mining,4 total
create Mithril Bar##10097,Mining,198 total
create Gold Bar##3308,Mining,10 total
step
...
collect 66 Solid Blasting Powder##10505
step
#include "trainer_Engineering"
...
step
#include "maincity_anvil"
create 35 Unstable Trigger##12591+,Engineering,32 total |tip Save 22 Unstable Triggers in your bags, you will need them later to create items.
...
collect 44 Mithril Casing##10561
step
#include "trainer_Engineering"
...
step
#include "auctioneer"
buy 28 Dense Stone##12365
buy 180 Thorium Bar##12359
buy 41 Runecloth##14047
#include go_farm,skill="Mining",req="200",goto="eng_250-280_farm"
next "eng_250-280_skill"
step
label  "eng_250-280_farm"
Skipping 1st part of farming |next "+farm2" |only if step:Find("+farming"):IsComplete() or skill("Engineering")>=280
Proceeding to farm |next |only if default
step
label "farming"
map Silithus
...
collect 28 Dense Stone##12365
#include "max_skill_warning",skill="Mining",goto="eng_125-210_farm"
step
label "farm2"
Skipping 2nd part of farming |next "+exit" |only if step:Find("+farming"):IsComplete() or skill("Engineering")>=280
Proceeding to farm |next |only if default
step
label "farming"
from Twilight Keeper Havunth##11804+, Twilight Geolord##11881+, Twilight Avenger##11880+, Twilight Stonecaller##11882+
collect 41 Runecloth##14047 |goto Silithus,45.8,38.2
You can find more:
Around [35.7,32.5]
Around [29.5,73.4]
Around [66.1,20.3]
...
step
label "farm"
Skipping 1st part of farming |next "+farm2" |only if step:Find("+farming"):IsComplete() or skill("Blacksmithing")>=350
Proceeding to farm |next |only if default
step
label "farming"
map Hellfire Peninsula
...
step
label "farm2"
Skipping 2nd part of farming |next "farmnether" |only if step:Find("+farming"):IsComplete() or skill("Blacksmithing")>=350
Proceeding to farm |next |only if default
step
label "farming"
map Nagrand
...
step
#include "maincity_anvil"
create 44 Handful of Fel Iron Bolts##30305,Engineering,44 total |tip Save 44 Fel Iron Bolts for making items later.
...
collect 12 Fel Iron Casing##23782
...
buy 58 Crystallized Water##37705
...
step
label "farm"
Skipping 1st part of farming |next "+farm2" |only if step:Find("+farming"):IsComplete() or skill("Blacksmithing")>=425
Proceeding to farm |next |only if default
step
label "farming"
map Borean Tundra
...
collect 58 Crystallized Water##37705
#include "max_skill_warning",skill="Mining",goto="eng_350-425_farm"
step
label "farm2"
Skipping 2nd part of farming |next "+exit" |only if step:Find("+farming"):IsComplete() or skill("Blacksmithing")>=425
Proceeding to farm |next |only if default
step
label "farming"
map Sholazar Basin
...
create Cobalt Bar##49252,Mining,220 total
step
...
collect 30 Volatile Blasting Trigger##39690 |tip Save 30 Volatile Blasting Trigger for crafting more items later.
step
#include "trainer_Engineering"
...
path	33.5,26.4
#include "follow_path_mine"
collect 216 Obsidium Ore##53038
#include "max_skill_warning",skill="Mining",goto="eng_425-500_farm" or skill("Blacksmithing")>=500
step
...
collect 30 Volatile Air##52328 |goto 34.6,69.2
You can find more over here [39.5,85.7]
step
#include "maincity_anvil"
create Elementium Bar##74530,Mining,76 total
create Obsidium Bar##84038,Mining,108 total
step
label  "eng_425-500_skill"
#include "maincity_anvil"
create 38 Handful of Obsidium Bolts##84403,Engineering,38 total
...
label "aid_1-75_farm"
from Riverpaw Bandit##452+, Riverpaw Brute##124+, Riverpaw Herbalist##501+
collect 160 Linen Cloth##2589 |goto Westfall,50.8,53.0
|next "aid_1-75_skill"
only if not completedq(26370)
step
from Rotted One##948+,Flesh Eater##3+,Bone Chewer##210+
collect 160 Linen Cloth##2589 |goto Duskwood,23.7,36.6
...
collect 75 Wool Cloth##2592 |goto Duskwood,21.4,68.7
step
...
collect 90 Silk Cloth##4306 |goto Dustwallow Marsh 46.7,46.7
step
...
from Irontree Chopper##48453+
collect 50 Mageweave Cloth##4338 |goto Felwood,63.4,20.7
step
...
Get your Fishing skill to level 75 |skill Fishing,75 |goto 54.6,69.0
step
...
Stand on the end of this wooden dock
Use your Fishing skill to fish in the water all around the wooden dock |cast Fishing##131474
Get your Fishing skill to level 150 |skill Fishing,150 |goto Stormwind City,55.0,69.7
step
...
Stand on the end of this wooden dock
Use your Fishing skill to fish in the water all around the wooden dock |cast Fishing##131474
Get your Fishing skill to level 225 |skill Fishing,225 |goto Stormwind City,55.0,69.7
step
...
Stand on the end of this wooden dock
Use your Fishing skill to fish in the water all around the wooden dock |cast Fishing##131474
Get your Fishing skill to level 300 |skill Fishing,300 |goto Stormwind City,55.0,69.7
step
...
Get your Fishing skill to level 375 |skill Fishing,375 |goto Stormwind City,55.0,69.7
step
...
Stand on the end of this wooden dock
Use your Fishing skill to fish in the water |cast Fishing##131474
Get your Fishing skill to level 450 |skill Fishing,450 |goto Stormwind City,55.0,69.7
step
...
Stand on the end of this wooden dock
Use your Fishing skill to fish in the water |cast Fishing##131474
Get your Fishing skill to level 525 |skill Fishing,525 |goto Stormwind City,55.0,69.7
step
label "route2"
...
#include "follow_path_herbs"
collect Kingsblood##3356 |n |tip This will become gray around 225, so you will need to focus on Khadgar's Whisker only when you get to that point.
collect Khadgar's Whisker##3358 |n
skill Herbalism,230
step
label	"farm2"
...
path	59.4,46.6	59.8,54.2	56.0,60.1
path	55.2,66.6	58.6,64.7	61.3,61.9
path	62.8,58.0	68.8,50.3	69.0,60.1
path	71.4,60.0	72.1,55.5	75.9,56.6
path	73.3,50.2
#include "follow_path_herbs"
...
buy 130 Light Parchment##39354 |goto 49.6,74.9
step
#include "auctioneer"
...
path	52.2,60.7	57.7,52.1
#include "follow_path_herbs"
ou need about 400 Azure-giving herbs total
collect Goldclover##36901 |n
collect Tiger Lily##36904 |n
You'll need about {_G.max(0 , (400-itemcount(36903,37921,39970,39969,36901,36907,36904,36906,36905)))} more herbs in stacks of 5.
...
collect 6 Volatile Water##52326 |goto Twilight Highlands 67.5,47.7
step
from Obsidian Stoneslave##47226+
collect 6 Volatile Earth##52327 |goto 57.9,31.2
step
from Enslaved Tempest##46328+
collect 6 Volatile Air##52328 |goto 34.6,69.2
...
label "farm2"
from Muddied Water Elemental##44011+
collect 12 Volatile Water##52326 |goto Twilight Highlands 67.5,47.7
step
from Flame Terror##52219+, Brimstone Destroyer##52794+, Charred Invader##52816+
collect 24 Volatile Fire##52325 |goto Mount Hyjal 20.0,58.6
step
label "ins_500-525_skill"
talk Una Kobuna##50248 |tip You can only see this NPC if you have completed the beginning quest chain for the Twilight Highlands.
buy 2 Deathwing Scale Fragment##62323 |goto Twilight Highlands,76,49
buy 1 Preserved Ogre Eye##67319 |goto Twilight Highlands,76,49
step
#include "vendor_Inscription"
...
skillmax Jewelcrafting,300 |goto 63.5,61.8
step
#include "auctioneer"
buy 5 Star Ruby##7910
...
collect 50 Thorium Bar##12359 |goto Silithus 54.9,36.6
step
...
get 10 Elemental Goo |q 25162/1 |goto Mount Hyjal,65.0,22.5
step
#include "trainer_Jewelcrafting"
...
learn Austere Shadowspirit Diamond##73468 |goto 63.8,61.5
step
...
label	"tl_1-75_farm"
from Rotted One##948+,Flesh Eater##3+,Bone Chewer##210+
collect 210 Linen Cloth##2589 |goto Duskwood,23.7,36.6
You can find more mobs in the crypt at [25.8,34.6]
Be sure to save any _Wool Cloth_ you pick up
step
label	"tl_1-75_skill"
...
collect 135 Wool Cloth##2592 |goto Wetlands 63.8,45.4
step
...
label	"farming"
from Irontree Chopper##48453+
collect 420 Mageweave Cloth##4338 |goto Felwood,63.4,20.7
step
...
from Twilight Keeper Havunth##11804+, Twilight Geolord##11881+, Twilight Avenger##11880+, Twilight Stonecaller##11882+
collect 800 Runecloth##14047 |goto Silithus,45.8,38.2
You can find more:
Around [35.7,32.5]
Around [29.5,73.4]
Around [66.1,20.3]
...
step
talk Eiin##19213
buy Pattern: Netherweave Tunic##21897 |goto Shattrath City,66.3,69.3
|next |only if rep ('The Aldor') >= Neutral
|next "auction2" |only if rep ('The Scryers') >= Friendly
step
talk Auctioneer Itoran##50143
buy 800 Netherweave Cloth##21877 |goto Shattrath City,51.0,26.5
#include go_farm_level,level="65",goto="tl_300-350_farm"
|next "tl_300-350_skill"
step
label	"auction2"
talk Auctioneer Kalaren##50139
buy 800 Netherweave Cloth##21877 |goto Shattrath City,57.0,63.2
#include go_farm_level,level="65",goto="tl_300-350_farm"
|next "tl_300-350_skill"
step
label	"tl_300-350_farm"
from Sunfury Magister##18855+, Sunfury Astromancer##19643+, Sunfury Captain##19453+, Sunfury Bloodwarder##18853+, Sunfury Geologist##19779+, Sunfury Warp-Master##18857+
collect 800 Netherweave Cloth##21877 |goto Netherstorm,26.3,68.1
step
...
accept Cloth Scavenging##13265 |instant |goto Borean Tundra 57.4,72.2
step
from Dark Ritualist##34734+, Dark Zealot##34728+
collect 1770 Frostweave Cloth##33470 |goto Icecrown,61.8,20.8
...
buy 50 Eternium Thread##38426 |goto 53.1,81.8
step
...
from Twilight Augur##40713+, Twilight Retainer##40767+
collect 1025 Embersilk Cloth##53010 |goto Mount Hyjal,55.8,68.0
...
from Twilight Augur##40713+, Twilight Retainer##40767+
collect 800 Embersilk Cloth##53010 |or |goto Mount Hyjal,55.8,68.0
or
create Bolt of Embersilk Cloth##74964,Tailoring,160 total |or |goto Mount Hyjal,55.8,68.0
step
from Flame Terror##52219+, Brimstone Destroyer##52794+
collect 75 Volatile Fire##52326 |goto Mount Hyjal 24.8,60.4
step
from Muddied Water Elemental
collect 75 Volatile Water##52326 |goto Twilight Highlands 68.6,47.0
step
...
Skin their corpses
collect 265 Heavy Leather##4234 |goto Feralas 55.4,55.0
collect 15 Heavy Hide##4235 |goto Feralas 55.4,55.0
...
collect 430 Thick Leather##4304 |goto Badlands 11.0,38.2
...
from Quillfang Ravager##16934+, Quillfang Skitterer##19189+
Skin their corpses
collect 20 Fel Scales##25700 |goto Hellfire Peninsula 22.2,67.1
collect 100 Knothide Leather Scraps##25649 |goto Hellfire Peninsula 22.2,67.1
...
label	"skinninglvl"
map Borean Tundra
path	49.8,67.7	46.9,70.7	44.2,71.0
path	41.1,70.7	38.5,71.8	41.9,74.4
path	45.3,74.9	48.1,74.4	49.6,72.3
path	51.6,69.1
Kill any beasts you see and skin them
...
Skin their corpses
collect 50 Savage Leather Scraps##52977 |goto Shimmering Expanse,49.7,61.1
...
step
from Obsidian Stoneslave##47226
collect 83 Volatile Earth##52327 |goto Twilight Highlands 59.0,30.8
step
label "lw_500-525_skill"
talk Ayla Shadowstorm##53881
buy 1 Pattern: Triple Reinforced Mining Bag##70175 |goto Molten Front 44.8,86.6
step
create Heavy Savage Leather##78436,Leatherworking,195 total
step
talk Tamar##3366
buy 17 Pristine Hide##52980 |goto Orgrimmar 60.5,54.4
step
...
learn Smelt Thorium##16153 |goto Tanaris,51.0,29.0
step
label "farm"
...
Click here to pick a different leather |confirm |next "start"
step "heavy"
from Feral Scar Yeti##5292+, Rage Scar Yeti##40224+ |goto Feralas 55.4,55.0
You can find more Yetis at [53.2,31.8]
Click here to pick a different leather |confirm |next "start"
step "thick"
from Nyxondra's Broodling##46916 |goto Badlands 11.0,38.2
Click here to pick a different leather |confirm |next "start"
step "rugged"
map Blasted Lands
path	56.8,39.1	57.5,34.0	55.4,31.3
...
step "linen"
from Riverpaw Bandit##452+, Riverpaw Brute##124+, Riverpaw Herbalist##501+ |goto Westfall,50.8,53.0
Click here to pick a different cloth |confirm |next "start"
only if not completedq(26370)
step
from Rotted One##948+,Flesh Eater##3+,Bone Chewer##210+ |goto Duskwood,23.7,36.6
You can find more mobs in the crypt at [25.8,34.6]
Click here to pick a different cloth |confirm |next "start"
step "wool"
from Dragonmaw Whelpstealer##42041+, Ebon Slavehunter##42043+ |goto Wetlands 63.8,45.4
Click here to pick a different cloth |confirm |next "start"
step "silk"
from Grimtotem Destroyer##23594+, Grimtotem Earthbinder##23595+ |goto Dustwallow Marsh 46.7,46.7
Click here to pick a different cloth |confirm |next "start"
step "mageweave"
from Irontree Chopper##48453+ |goto Felwood,63.4,20.7
Click here to pick a different cloth |confirm |next "start"
step "rune"
from Twilight Keeper Havunth##11804+, Twilight Geolord##11881+, Twilight Avenger##11880+, Twilight Stonecaller##11882+ |goto Silithus,45.8,38.2
You can find more:
Around [35.7,32.5]
Around [29.5,73.4]
Around [66.1,20.3]
Click here to pick a different cloth |confirm |next "start"
step "netherweave"
from Sunfury Magister##18855+, Sunfury Astromancer##19643+, Sunfury Captain##19453+, Sunfury Bloodwarder##18853+, Sunfury Geologist##19779+, Sunfury Warp-Master##18857+ |goto Netherstorm,26.3,68.1
Click here to pick a different cloth |confirm |next "start"
step "frostweave"
from Dark Ritualist##34734+,Dark Zealot##34728+ |goto Icecrown,61.8,20.8
Click here to pick a different cloth |confirm |next "start"
step "embersilk"
from Twilight Augur##40713+, Twilight Retainer##40767+ |goto Mount Hyjal,35.0,24.0
Click here to pick a different cloth |confirm |next "start"
step "windwool"
from Springtail Leaper##57415+, Springtail Gnasher##57413+ |goto Valley of the Four Winds 43.9,38.6
Click here to pick a different cloth |confirm |next "start"
only if ZGV.guidesets['ProfessionsAMoP']
]])
...
buy 1 Recipe: Brilliant Smallfish##6325 |goto Stormwind City 55.0,69.6
buy 1 Recipe: Longjaw Mud Snapper##6328 |goto Stormwind City 55.0,69.6
step
talk Kelsey Yance##2664
buy Recipe: Filet of Redgill##13941 |goto The Cape of Stranglethorn 42.8,69.0
step
learn Brilliant Smallfish##7751 |use Recipe: Brilliant Smallfish##6325
step
talk Stephen Ryback##5482
skillmax Cooking,75 |goto Stormwind City 77.2,53.3
step
talk Arnold Leland##5493
skillmax Fishing,75 |goto Stormwind City 54.8,69.6
step
...
collect 35 Raw Brilliant Smallfish##6291 |n |goto Stormwind City 54.6,69.0
collect 25 Raw Longjaw Mud Snapper##6289 |n |goto Stormwind City 54.6,69.0
collect 25 Raw Bristle Whisker Catfish##6308 |n |goto Stormwind City 54.6,69.0
You will need at least _35 Raw Brilliant Smallfish_ and _20 Raw Longjaw Mud Snappers_
step
talk Arnold Leland##5493
skillmax Fishing,150 |goto Stormwind City 54.8,69.6
step
Equip your Fishing Pole |use Fishing Pole##6256
Use your _Shiny Bauble_ |use Shiny Bauble##6529
Use your Fishing skill to fish in the water all around the wooden dock |cast Fishing##131474
collect 50 Raw Brilliant Smallfish##6291 |goto Stormwind City 54.6,69.0
collect 50 Raw Longjaw Mud Snapper##6289  |goto Stormwind City 54.6,69.0
collect 25 Raw Bristle Whisker Catfish##6308 |goto Stormwind City 54.6,69.0
Get your Fishing skill to level 150 |skill Fishing,150 |goto Stormwind City 54.6,69.0
step
talk Arnold Leland##5493
skillmax Fishing,225 |goto Stormwind City 54.6,69.0
step
create 50 Brilliant Smallfish,Cooking,50 |goto Stormwind City 77.3,53.3
If you didn't reach 50 Cooking, you will need to fish up more _Raw Brilliant Smallfish_
step
talk Stephen Ryback##5482
skillmax Cooking,150 |goto Stormwind City 77.2,53.3
step
learn Longjaw Mud Snapper##7753 |use Recipe: Longjaw Mud Snapper##6328
step
create Longjaw Mud Snapper##7753,Cooking,100 |goto Stormwind City 77.3,53.3
If you didn't reach 100 Cooking, you will need to fish up more _Raw Longjaw Mud Snappers_
step
talk Catherine Leland##5494
buy 1 Recipe: Bristle Whisker Catfish##6330 |goto Stormwind City 55.0,69.6
step
learn Bristle Whisker Catfish##7755 |use Recipe: Bristle Whisker Catfish##6330
step
talk Stuart Fleming##3178
buy 5 Bright Baubles##6532 |goto Wetlands/0 6.3,57.4
buy 1 Recipe: Mithril Head Trout##17062 |goto Wetlands/0 6.3,57.4
step
...
Get your Fishing skill to level 215 |skill Fishing,215 |goto Wetlands/0 22.8,40.0
step
talk Harold Riggs##3179
skillmax Fishing,300 |goto Wetlands/0 8.1,58.6
step
Use your _Bright Baubles_ |use Bright Baubles##6532
Use your Fishing skill at the pool of water here |cast Fishing##131474
collect 35 Raw Longjaw Mud Snapper##6289+ |goto Wetlands/0 22.8,40.0
collect 85 Raw Bristle Whisker Catfish##6308+ |goto Wetlands/0 22.8,40.0
step
talk Stuart Fleming##3178
buy 5 Bright Baubles##6532 |goto Wetlands/0 6.3,57.4
step
create Longjaw Mud Snapper##7753,Cooking,115 |goto Dustwallow Marsh/0 66.9,45.3
step
create Bristle Whisker Catfish##7755,Cooking,150
step
talk Craig Nollward##4894
skillmax Cooking,225 |goto Dustwallow Marsh/0 66.9,45.3
step
Use your _Bright Baubles_ |use Bright Baubles##6532
Use your Fishing skill at the pool of water here |cast Fishing##131474
collect 40 Raw Bristle Whisker Catfish##6308 |n |goto Dustwallow Marsh/0 58.4,25.4
collect 70 Raw Mithril Head Trout##8365 |n |goto Dustwallow Marsh/0 58.4,25.4
Get your Fishing skill to level 275 |skill Fishing,275 |goto Dustwallow Marsh/0 58.4,25.4
step
Collect the amount of fish listed below
collect 40 Raw Bristle Whisker Catfish##6308 |goto Dustwallow Marsh/0 58.4,25.4
collect 70 Raw Mithril Head Trout##8365 |goto Dustwallow Marsh/0 58.4,25.4
step
create Bristle Whisker Catfish##7755,Cooking,175 |goto Dustwallow Marsh/0 67.0,45.3
step
learn Mithril Head Trout##20916 |use Recipe: Mithril Head Trout##17062
step
create Mithril Head Trout##20916,Cooking,225 |goto Dustwallow Marsh/0 67.0,45.3
step
talk Craig Nollward##4894
skillmax Cooking,300 |goto Dustwallow Marsh 66.8,45.2
step
talk Vivianna##7947
buy 1 Recipe: Baked Salmon##13949 |goto Feralas 46.2,41.6
step
talk Harold Riggs##3179
skillmax Fishing,375 |goto Wetlands/0 8.1,58.6
step
talk Stuart Fleming##3178
buy 5 Bright Baubles##6532 |goto Wetlands/0 6.3,57.4
step
Use your _Bright Baubles_ |use Bright Baubles##6532
Use your Fishing skill at the pool of water here |cast Fishing##131474
collect 15 Raw Mithril Head Trout##8365 |n |goto Eastern Plaguelands/0 47.0,62.0
collect 35 Raw Redgill##13758 |n |goto Eastern Plaguelands/0 47.0,62.0
collect Raw Sunscale Salmon##13760 |n |goto Eastern Plaguelands/0 47.0,62.0
collect Raw Nightfin Snapper##13759 |n |goto Eastern Plaguelands/0 47.0,62.0
Get your Fishing skill to level 310 |skill Fishing,310 |goto Eastern Plaguelands/0 47.0,62.0
step
Depending on the time of day, you will catch either Sunscale Salmon or Nightfin Snappers
Use your _Bright Baubles_ |use Bright Baubles##6532
Use your Fishing skill at the pool of water here |cast Fishing##131474
collect 15 Raw Mithril Head Trout##8365 |goto Eastern Plaguelands/0 47.0,62.0
collect 35 Raw Redgill##13758  |goto Eastern Plaguelands/0 47.0,62.0
collect Raw Sunscale Salmon##13760 |n |goto Eastern Plaguelands/0 47.0,62.0
collect Raw Nightfin Snapper##13759 |n |goto Eastern Plaguelands/0 47.0,62.0
...
step
talk Stephen Ryback##5482
learn Nightfin Soup##18243 |goto Stormwind City/0 77.3,53.2
learn Poached Sunscale Salmon##18244 |goto Stormwind City/0 77.3,53.2
step
talk Donna Berrymore##44334
buy 50 Refreshing Spring Water##159 |or |goto Blasted Lands 44.4,87.7
collect 50 Refreshing Spring Water##159 |goto Blasted Lands 44.4,87.7
step
Depending on the time of day, you will catch either Sunscale Salmon or Nightfin Snappers
Use your _Bright Baubles_ |use Bright Baubles##6532
Use your Fishing skill at the pool of water here |cast Fishing##131474
collect 55 Raw Sunscale Salmon##13760 |n |goto Blasted Lands/0 40.7,77.1
collect 55 Raw Nightfin Snapper##13759 |n |goto Blasted Lands/0 40.7,77.1
collect 30 Raw Whitescale Salmon##13889 |n |goto Blasted Lands/0 40.7,77.1
Get your Fishing skill to level 330 |skill Fishing,330 |goto Blasted Lands/0 40.7,77.1
step
Depending on the time of day, you will catch either Sunscale Salmon or Nightfin Snappers
Use your _Bright Baubles_ |use Bright Baubles##6532
Use your Fishing skill at the pool of water here |cast Fishing##131474
You will only need a combined total of 55 fish between Sunscale Salmon and Nightfin Snappers
collect 55 Raw Sunscale Salmon##13760 |or |goto Blasted Lands/0 40.7,77.1
collect 55 Raw Nightfin Snapper##13759 |or |goto Blasted Lands/0 40.7,77.1
collect 30 Raw Whitescale Salmon##13889  |goto Blasted Lands/0 40.7,77.1
step
Create a Cooking Fire |cast Cooking Fire##818
...
create Poached Sunscale Salmon##18244,Cooking,285 |goto Blasted Lands 40.5,77.0
step
...
step
talk Doba##20028
buy 1 Recipe: Feltail Delight##27695 |goto Zangarmarsh 42.2,27.8
buy 1 Recipe: Blackened Trout##27694 |goto Zangarmarsh 42.2,27.8
step
talk Innkeeper Biribi##19296
buy 1 Recipe: Golden Fish Sticks##27699 |goto Terokkar Forest 56.6,53.2
step
talk Kylene##19186
skillmax Cooking,375 |goto Shattrath City/0 74.8,30.9
step
Use your _Bright Baubles_ |use Bright Baubles##6532
Riase your _Fishing Skill_ to levle 365 |skill Fishing,365 |goto Terokkar Forest/0 39.6,22.5
step
Use your _Bright Baubles_ |use Bright Baubles##6532
collect 10 Spotted Feltail##27425 |goto Terokkar Forest/0 39.6,22.5
collect 50 Barbed Gill Trout##27422 |goto Terokkar Forest/0 39.6,22.5
collect 15 Golden Darter##27438 |goto Terokkar Forest/0 39.6,22.5
step
...
step
talk Kylene##19186
learn Stewed Trout##42296 |goto Shattrath City/0 74.8,30.9
step
Create a Cooking Fire |cast Cooking Fire##818
...
step
talk Derek Odds##31032
buy 1 Recipe: Imperial Manta Steak##43026 |goto Dalaran/1 40.7,66.0
buy 50 Northern Spices##43007 |goto Dalaran/1 40.7,66.0
step
talk Rollick MacKreel##26989
skillmax Cooking,450 |goto Borean Tundra/0 57.9,71.5
step
talk Old Man Robert##26993
skillmax Fishing,450 |goto Borean Tundra/0 57.9,71.6
step
talk Old Man Robert##26993
learn Smoked Rockfin##45560 |goto Borean Tundra/0 57.9,71.6
learn Dalaran Clam Chowder##58065 |goto Borean Tundra/0 57.9,71.6
learn Baked Manta Ray##45569 |goto Borean Tundra/0 57.9,71.6
step
Use your _Bright Baubles_ |use Bright Baubles##6532
Raise your _Fishing Skill_ to level 450 |skill Fishing,450 |goto Borean Tundra/0 54.0,73.4
step
talk Old Man Robert##26993
skillmax Fishing,525 |goto Borean Tundra/0 57.9,71.6
step
Use your _Bright Baubles_ |use Bright Baubles##6532
Raise your _Fishing Skill_ to level 475 |skill Fishing,475 |goto Borean Tundra/0 54.0,73.4
step
Fish in the water here
collect 40 Succulent Clam Meat##36782 |goto Borean Tundra/0 54.0,73.4
collect 70 Rockfin Grouper##41803 |goto Borean Tundra/0 54.0,73.4
collect 70 Imperial Manta Ray##41802 |goto Borean Tundra/0 54.0,73.4
collect 70 Man O' War##41805 |goto Borean Tundra/0 54.0,73.4
Open your _Darkwater Clams_ to collect _Succulent Clam Meat_ |use Darkwater Clam##36781
...
step
Create a Cooking Fire |cast Cooking Fire##818
create Smoked Rockfin##45560,Cooking,375 |goto Borean Tundra/0 57.8,71.4
step
Create a Cooking Fire |cast Cooking Fire##818
...
step
talk Rollick MacKreel##26989
learn Black Jelly##64358 |goto Borean Tundra/0 57.9,71.5
step
Create a Cooking Fire |cast Cooking Fire##818
...
step
talk Rollick MacKreel##26989
skillmax Cooking,525 |goto Borean Tundra/0 57.9,71.5
step
talk Bario Matalli##49701
buy 1 Recipe: Lightly Fried Lurker##65412 |goto Stormwind City/0 50.4,71.9
buy 1 Recipe: Fish Fry##65423 |goto Stormwind City/0 50.4,71.9
buy 1 Recipe: Delicious Sagefish Tail##65422 |goto Stormwind City/0 50.4,71.9
buy 1 Recipe: Baked Rockfish##65426 |goto Stormwind City/0 50.4,71.9
buy 1 Recipe: Pickled Guppy##65417 |goto Stormwind City/0 50.4,71.9
step
learn Lightly Fried Lurker##88028 |use Recipe: Lightly Fried Lurker##65412
step
Use your _Bright Baubles_ |use Bright Baubles##6532
Raise your _Fishing Skill_ to level 500 |skill Fishing,500 |goto Twilight Highlands/0 56.1,37.3
step
Fish in the water here
collect 40 Striped Lurker##53067 |goto Twilight Highlands/0 56.1,37.3
collect 20 Highland Guppy##53064 |goto Twilight Highlands/0 56.1,37.3
collect 70 Sharptooth##53062 |goto Twilight Highlands/0 56.1,37.3
step
talk Arnold Leland##5493
skillmax Fishing,600 |goto Stormwind City/0 54.8,69.6
step
create Lightly Fried Lurker##88028,Cooking,475 |goto Stormwind City/0 77.5,52.9
step
...
step
talk Stephen Ryback##5482
skillmax Cooking,600 |goto Stormwind City/0 77.3,53.2
step
talk Catherine Leland##5494
You will need 625 fishing to stop catching junk
If you reach 550 Fishing, start using the _Bright Baubles_
collect 10 Bright Baubles##6532 |goto Stormwind City/0 55.0,69.7
step
Use your _Bright Baubles_ |use Bright Baubles##6532
...
Reach _525_ Cooking |skill Cooking,525 |goto Twilight Highlands/0 78.1,77.3
step
...
learn Krasarang Fritters##124032 |goto Valley of the Four Winds 52.6,51.6
step
Use your _Bright Baubles_ |use Bright Baubles##6532
collect 5 Krasarang Paddlefish##74865
collect 55 Emperor Salmon##74859
Save any fish you get
Level your fishing to 600 |skill Fishing,600 |goto Valley of the Four Winds/0 59.0,50.3
step
...
buy 5 Rice##74851 |q 31302 |goto 53.6,51.2
buy 5 Yak Milk##74852 |q 31302 |goto 53.6,51.2
step
#include cooking_fire
...
get 5 Giant Mantis Shrimp##74857 |q 31475/1 |goto 53.5,51.2
step
...
collect 15 Giant Mantis Shrimp##74857 |goto Valley of the Four Winds 53.5,51.2
|next create_shrimp
step
label	farm_shrimp
...
collect 50 Giant Mantis Shrimp##74857 |goto Krasarang Wilds 67.9,49.6
step
label	create_shrimp
#include cooking_fire
...
Equip your Fishing Pole, if it's not already equipped |use Fishing Pole##6256
Use your Fishing skill to fish in the water here. You can look for fishing pools around the beach also |cast Fishing##131474
collect 13 Emperor Salmon##74859 |goto Krasarang Wilds 37.4,35.2
step
...
collect 60 Scallions##74843 |goto Krasarang Wilds 62.0,40.6
...
collect 13 Emperor Salmon##74859 |goto Valley of the Four Winds 53.5,51.2
...
collect 60 Scallions##74843 |goto Valley of the Four Winds 53.5,51.2
|next create_fire_spirit
step
...
step
talk Yan Ironpaw##58715
learn Banquet of the Steamer##125598 |goto Valley of the Four Winds/0 52.6,51.7
step
#include "auctioneer"
...
Equip your Fishing Pole, if it's not already equipped |use Fishing Pole##6256
Use your Fishing skill to fish in the water here. You can look for fishing pools around the beach also |cast Fishing##131474
collect 50 Emperor Salmon##74859 |goto Krasarang Wilds 37.4,35.2
step
...
collect 50 Wildfowl Breast##74839 |goto Krasarang Wilds 64.6,29.3
step
label	farm_banquet_steam_3
from Unga Fish-Getter##60299+, Unga Villager##60358+
collect 250 Jade Squash##74847 |goto Krasarang Wilds 46.0,86.6
|next create_banquet_steam
step
...
collect 50 Wildfowl Breast##74839 |goto Valley of the Four Winds 53.5,51.2
buy Sack of Emperor Salmon##87723 |n
You need _{_G.ceil(_G.max(0, ((50-itemcount(74859))/5)-itemcount(87723)))} Sacks of Salmon_
Open the Sack to collect the ingredients |use Sack of Emperor Salmon##87723
collect 50 Emperor Salmon##74859 |goto Valley of the Four Winds 53.5,51.2
...
collect 250 Jade Squash##74847 |goto Valley of the Four Winds 53.5,51.2
step
