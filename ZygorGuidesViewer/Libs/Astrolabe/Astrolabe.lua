...
function Astrolabe:GetCurrentPlayerPosition(allow_last)
	...
	then
		...
		m,f = 941,1
	elseif m==941 and f==0 and C_Garrison.GetGarrisonInfo() and (x-0.486031)*(x-0.486031) + (y-0.660961)*(y-0.660961)*0.5 < 0.0015 then  -- in Frostfire there's Frostwall!  -- 0.452885<x<0.519177 , 0.614024<y<0.707698
		x,y = Astrolabe:TranslateWorldMapPosition( m, f, x, y, 976, 0 )
		m,f = 976,0
	elseif m==947 and f==0 and C_Garrison.GetGarrisonInfo() and (x-0.3)*(x-0.3) + (y-0.17)*(y-0.17)*1.5 < 0.002 then  -- in Shadowmoon there's Lunarfall!
