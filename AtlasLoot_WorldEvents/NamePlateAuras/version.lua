...
function events:CHAT_MSG_ADDON(event, prefix, message, channel, sender)
	...
	if version and source then
		...
		if cntrV > cntrmV then
			remindMeagain = false
			print("NamePlateAuras: New version".." "..version.." ".."availible on".." ".."http://aleaaddons.ru")
		end
	end
end
...
function events:PLAYER_LOGIN()
	...
	print("NamePlateAuras: Loaded v"..version..". New updates availible on".." ".."http://aleaaddons.ru")
